...
$page_title       = 'ListView: Subject';
$db_subclass      = 'subject';
$html_subclass    = 'subject_html';
$arr_pkey_name    = array('subject_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add subject';
$edit_link        = 'Edit subject';
$delete_link      = 'Delete subject';
$view_link        = 'View subject';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_subject.php';
$edit_page        = 'edit_subject.php';
$delete_page      = 'delete_subject.php';
$view_page        = 'detailview_subject.php';
$csv_page         = 'csv_subject.php';
$report_page      = 'reporter_subject.php';
