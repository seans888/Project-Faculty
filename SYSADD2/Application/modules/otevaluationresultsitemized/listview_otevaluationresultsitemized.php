...
$page_title       = 'ListView: Otevaluationresultsitemized';
$db_subclass      = 'otevaluationresultsitemized';
$html_subclass    = 'otevaluationresultsitemized_html';
$arr_pkey_name    = array('period','target_id','item_id','subject_code','section');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationresultsitemized';
$edit_link        = 'Edit otevaluationresultsitemized';
$delete_link      = 'Delete otevaluationresultsitemized';
$view_link        = 'View otevaluationresultsitemized';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationresultsitemized.php';
$edit_page        = 'edit_otevaluationresultsitemized.php';
$delete_page      = 'delete_otevaluationresultsitemized.php';
$view_page        = 'detailview_otevaluationresultsitemized.php';
$csv_page         = 'csv_otevaluationresultsitemized.php';
$report_page      = 'reporter_otevaluationresultsitemized.php';
