...
//****************************************************************************************
require 'path.php';
init_cobalt('View facultyload');

$page_title       = 'ListView: Facultyload';
$db_subclass      = 'facultyload';
$html_subclass    = 'facultyload_html';
$arr_pkey_name    = array('load_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add facultyload';
$edit_link        = 'Edit facultyload';
$delete_link      = 'Delete facultyload';
$view_link        = 'View facultyload';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_facultyload.php';
$edit_page        = 'edit_facultyload.php';
$delete_page      = 'delete_facultyload.php';
$view_page        = 'detailview_facultyload.php';
$csv_page         = 'csv_facultyload.php';
$report_page      = 'reporter_facultyload.php';
