...
//****************************************************************************************
require 'path.php';
init_cobalt('Edit otevaluationresultspersection');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        $message .= $dbh_otevaluationresultspersection->sanitize($arr_form_data)->lst_error;
        extract($arr_form_data);

        if($dbh_otevaluationresultspersection->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_otevaluationresultspersection->edit($arr_form_data);
...
$html->draw_header('Edit Otevaluationresultspersection', $message, $message_type);
