...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_otevaluationresultspersection.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_otevaluationresultspersection_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_otevaluationresultspersection->export_to_csv();
...
$html->draw_header('CSV Exporter: Otevaluationresultspersection', $message, $message_type);
