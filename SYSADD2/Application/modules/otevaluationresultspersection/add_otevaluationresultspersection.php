...
//****************************************************************************************
require 'path.php';
init_cobalt('Add otevaluationresultspersection');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_otevaluationresultspersection->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_otevaluationresultspersection->add($arr_form_data);
...
$html->draw_header('Add Otevaluationresultspersection', $message, $message_type);
