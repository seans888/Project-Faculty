...
//****************************************************************************************
require 'path.php';
init_cobalt('Add otevaluationitemsgrouping');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_otevaluationitemsgrouping->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_otevaluationitemsgrouping->add($arr_form_data);
...
$html->draw_header('Add Otevaluationitemsgrouping', $message, $message_type);
