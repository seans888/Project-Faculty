...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_refsubjectoteclassification.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_refsubjectoteclassification_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_refsubjectoteclassification->export_to_csv();
...
$html->draw_header('CSV Exporter: Refsubjectoteclassification', $message, $message_type);
