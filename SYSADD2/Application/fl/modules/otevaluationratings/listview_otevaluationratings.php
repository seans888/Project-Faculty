...
$page_title       = 'ListView: Otevaluationratings';
$db_subclass      = 'otevaluationratings';
$html_subclass    = 'otevaluationratings_html';
$arr_pkey_name    = array('period','stud_id','item_id','target_id','subject_code','section');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationratings';
$edit_link        = 'Edit otevaluationratings';
$delete_link      = 'Delete otevaluationratings';
$view_link        = 'View otevaluationratings';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationratings.php';
$edit_page        = 'edit_otevaluationratings.php';
$delete_page      = 'delete_otevaluationratings.php';
$view_page        = 'detailview_otevaluationratings.php';
$csv_page         = 'csv_otevaluationratings.php';
$report_page      = 'reporter_otevaluationratings.php';
