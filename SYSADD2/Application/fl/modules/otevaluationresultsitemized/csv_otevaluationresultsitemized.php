...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_otevaluationresultsitemized.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_otevaluationresultsitemized_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_otevaluationresultsitemized->export_to_csv();
...
$html->draw_header('CSV Exporter: Otevaluationresultsitemized', $message, $message_type);
