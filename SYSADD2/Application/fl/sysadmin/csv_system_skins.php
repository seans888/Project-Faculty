...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_system_skins.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_system_skins_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' . $csv_name;

            $csv_contents = $dbh_system_skins->export_to_csv();
...
$html->draw_header('CSV Exporter: System Skins', $message, $message_type);
