...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_person_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' . $csv_name;

            $csv_contents = $dbh_person->export_to_csv();
...
$html->draw_header('CSV Exporter: Person', $message, $message_type);
