...
class otevaluationclassifications extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('id, classification');
            $this->set_values("?,?");

            $bind_params = array('is',
                                 &$this->fields['id']['value'],
                                 &$this->fields['classification']['value']);
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("classification = ?");
            $this->set_where("id = ?");
