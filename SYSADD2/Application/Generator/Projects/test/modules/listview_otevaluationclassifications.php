...
$page_title       = 'ListView: Otevaluationclassifications';
$db_subclass      = 'otevaluationclassifications';
$html_subclass    = 'otevaluationclassifications_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationclassifications';
$edit_link        = 'Edit otevaluationclassifications';
$delete_link      = 'Delete otevaluationclassifications';
$view_link        = 'View otevaluationclassifications';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationclassifications.php';
$edit_page        = 'edit_otevaluationclassifications.php';
$delete_page      = 'delete_otevaluationclassifications.php';
$view_page        = 'detailview_otevaluationclassifications.php';
$csv_page         = 'csv_otevaluationclassifications.php';
$report_page      = 'reporter_otevaluationclassifications.php';
