...
$page_title       = 'ListView: Otevaluationperiod';
$db_subclass      = 'otevaluationperiod';
$html_subclass    = 'otevaluationperiod_html';
$arr_pkey_name    = array('period');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationperiod';
$edit_link        = 'Edit otevaluationperiod';
$delete_link      = 'Delete otevaluationperiod';
$view_link        = 'View otevaluationperiod';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationperiod.php';
$edit_page        = 'edit_otevaluationperiod.php';
$delete_page      = 'delete_otevaluationperiod.php';
$view_page        = 'detailview_otevaluationperiod.php';
$csv_page         = 'csv_otevaluationperiod.php';
$report_page      = 'reporter_otevaluationperiod.php';
