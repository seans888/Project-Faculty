...
//****************************************************************************************
require 'path.php';
init_cobalt('Delete otevaluationresultsgrouped');
...
if(isset($_GET['period']) && isset($_GET['target_id']) && isset($_GET['group_id']) && isset($_GET['subject_code']) && isset($_GET['section']))
{
    ...
    require_once 'form_data_otevaluationresultsgrouped.php';
}
...
$html->draw_header('Delete Otevaluationresultsgrouped', $message, $message_type);
