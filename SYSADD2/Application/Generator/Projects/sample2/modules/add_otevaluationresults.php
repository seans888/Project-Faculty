...
//****************************************************************************************
require 'path.php';
init_cobalt('Add otevaluationresults');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_otevaluationresults->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_otevaluationresults->add($arr_form_data);
...
$html->draw_header('Add Otevaluationresults', $message, $message_type);
