...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_otevaluationresultsgrouped.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_otevaluationresultsgrouped_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_otevaluationresultsgrouped->export_to_csv();
...
$html->draw_header('CSV Exporter: Otevaluationresultsgrouped', $message, $message_type);
