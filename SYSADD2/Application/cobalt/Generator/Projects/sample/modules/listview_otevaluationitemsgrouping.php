...
$page_title       = 'ListView: Otevaluationitemsgrouping';
$db_subclass      = 'otevaluationitemsgrouping';
$html_subclass    = 'otevaluationitemsgrouping_html';
$arr_pkey_name    = array('group_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationitemsgrouping';
$edit_link        = 'Edit otevaluationitemsgrouping';
$delete_link      = 'Delete otevaluationitemsgrouping';
$view_link        = 'View otevaluationitemsgrouping';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationitemsgrouping.php';
$edit_page        = 'edit_otevaluationitemsgrouping.php';
$delete_page      = 'delete_otevaluationitemsgrouping.php';
$view_page        = 'detailview_otevaluationitemsgrouping.php';
$csv_page         = 'csv_otevaluationitemsgrouping.php';
$report_page      = 'reporter_otevaluationitemsgrouping.php';
