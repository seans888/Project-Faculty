...
//****************************************************************************************
require 'path.php';
init_cobalt('View otevaluationitems');

$page_title       = 'ListView: Otevaluationitems';
$db_subclass      = 'otevaluationitems';
$html_subclass    = 'otevaluationitems_html';
$arr_pkey_name    = array('period','item_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add otevaluationitems';
$edit_link        = 'Edit otevaluationitems';
$delete_link      = 'Delete otevaluationitems';
$view_link        = 'View otevaluationitems';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_otevaluationitems.php';
$edit_page        = 'edit_otevaluationitems.php';
$delete_page      = 'delete_otevaluationitems.php';
$view_page        = 'detailview_otevaluationitems.php';
$csv_page         = 'csv_otevaluationitems.php';
$report_page      = 'reporter_otevaluationitems.php';
