...
$page_title       = 'ListView: Award';
$db_subclass      = 'award';
$html_subclass    = 'award_html';
$arr_pkey_name    = array('award_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add award';
$edit_link        = 'Edit award';
$delete_link      = 'Delete award';
$view_link        = 'View award';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_award.php';
$edit_page        = 'edit_award.php';
$delete_page      = 'delete_award.php';
$view_page        = 'detailview_award.php';
$csv_page         = 'csv_award.php';
$report_page      = 'reporter_award.php';
