...
$page_title       = 'ListView: Employee Awards';
$db_subclass      = 'employee_awards';
$html_subclass    = 'employee_awards_html';
$arr_pkey_name    = array('emp_id','auto_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add employee awards';
$edit_link        = 'Edit employee awards';
$delete_link      = 'Delete employee awards';
$view_link        = 'View employee awards';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_employee_awards.php';
$edit_page        = 'edit_employee_awards.php';
$delete_page      = 'delete_employee_awards.php';
$view_page        = 'detailview_employee_awards.php';
$csv_page         = 'csv_employee_awards.php';
$report_page      = 'reporter_employee_awards.php';
