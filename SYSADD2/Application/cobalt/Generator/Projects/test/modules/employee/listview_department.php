...
$page_title       = 'ListView: Department';
$db_subclass      = 'department';
$html_subclass    = 'department_html';
$arr_pkey_name    = array('dept_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add department';
$edit_link        = 'Edit department';
$delete_link      = 'Delete department';
$view_link        = 'View department';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_department.php';
$edit_page        = 'edit_department.php';
$delete_page      = 'delete_department.php';
$view_page        = 'detailview_department.php';
$csv_page         = 'csv_department.php';
$report_page      = 'reporter_department.php';
