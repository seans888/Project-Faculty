...
$page_title       = 'ListView: Experiments';
$db_subclass      = 'experiments';
$html_subclass    = 'experiments_html';
$arr_pkey_name    = array('experiment_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add experiments';
$edit_link        = 'Edit experiments';
$delete_link      = 'Delete experiments';
$view_link        = 'View experiments';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_experiments.php';
$edit_page        = 'edit_experiments.php';
$delete_page      = 'delete_experiments.php';
$view_page        = 'detailview_experiments.php';
$csv_page         = 'csv_experiments.php';
$report_page      = 'reporter_experiments.php';
