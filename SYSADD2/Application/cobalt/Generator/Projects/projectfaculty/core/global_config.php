<?php
define('GLOBAL_PROJECT_NAME', 'Faculty Loading System');
define('GLOBAL_SESSION_NAME', 'C5300cb63');

//Default database settings
define('DEFAULT_DB_HOST','localhost');
define('DEFAULT_DB_USER','root');
define('DEFAULT_DB_PASS','');
define('DEFAULT_DB_USE' ,'projectdatabase');

//Paths and directory names
define('BASE_DIRECTORY', 'projectfaculty');
...
define('TMP_DIRECTORY', 'C:\Users\Rafa\Documents\Project-Faculty\SYSADD2\Application' . '/' . BASE_DIRECTORY . '/tmp');
