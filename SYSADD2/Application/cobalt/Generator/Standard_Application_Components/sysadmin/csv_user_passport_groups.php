...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_user_passport_groups.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_user_passport_groups_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' . $csv_name;

            $csv_contents = $dbh_user_passport_groups->export_to_csv();
...
$html->draw_header('CSV Exporter: User Passport Groups', $message, $message_type);
