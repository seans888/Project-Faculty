					...
					while ($faculty = mysqli_fetch_assoc($records1))
					{
						...
						while ($subject = mysqli_fetch_assoc($records2))
						{
							if ($subject['start_time'] == "07:30" && $subject['occupied'] == 'n' && $faculty['seven_thirty'] == 'n')
							{
								...
								{
									$insert = "INSERT INTO `load`(`facultyID`, `faculty_first_name`, `faculty_last_name`, `full-time/part-time`, `specialization`, `ote`, `subjectid`, `subject_name`, `subject_desc`, `unit`, `start_time`, `end_time`, `load_creator`) VALUES ";
									$insert .= "(";
