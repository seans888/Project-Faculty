...
$dbh_subject->set_fields('term_id, subject_code, subject_name, subject_description, unit, pay_unit, compute_GPA, lab_id, group_owner, evaluate_OTE, is_elective, grade_type, accept_substitute, lab_type_id, dept_id, category, assess_note');
$dbh_subject->set_where("specialization_id='" . quote_smart($specialization_id) . "'");
