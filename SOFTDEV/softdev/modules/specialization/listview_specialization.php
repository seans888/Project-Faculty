...
$page_title       = 'ListView: %%';
$db_subclass      = 'specialization';
$html_subclass    = 'specialization_html';
$arr_pkey_name    = array('specialization_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add specialization';
$edit_link        = 'Edit specialization';
$delete_link      = 'Delete specialization';
$view_link        = 'View specialization';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_specialization.php';
$edit_page        = 'edit_specialization.php';
$delete_page      = 'delete_specialization.php';
$view_page        = 'detailview_specialization.php';
$csv_page         = 'csv_specialization.php';
$report_page      = 'reporter_specialization.php';
