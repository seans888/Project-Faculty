...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $dbh_facultyload->delete_many($arr_form_data);

            for($a=0; $a<$facultyload_count;$a++)
            {
                
                $param = array(
                               'emp_id'=>$emp_id,
                               'subject_offering_id'=>$cf_facultyload_subject_offering_id[$a],
                               'date'=>$cf_facultyload_date[$a]
                              );
            ...
            for($a=0; $a<$specialization_count;$a++)
            {
                ...
                $param = array(
                               'emp_id'=>$emp_id,
                               'specialization_name'=>$cf_specialization_specialization_name[$a],
                               'specialization_desc'=>$cf_specialization_specialization_desc[$a]
                              );
