...
class otevaluationresultspersection extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('emp_id, period, target_id, subject_code, section, evaluators, final_grade');
            $this->set_values("?,?,?,?,?,?,?");

            $bind_params = array('sisssis',
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("emp_id = ?, period = ?, target_id = ?, subject_code = ?, section = ?, evaluators = ?, final_grade = ?");
            $this->set_where("period = ? AND target_id = ? AND subject_code = ? AND section = ?");

            $bind_params = array('sisssisisss',
                                 &$this->fields['emp_id']['value'],
                                 &$this->fields['period']['value'],
                                 &$this->fields['target_id']['value'],
                                 &$this->fields['subject_code']['value'],
