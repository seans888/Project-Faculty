    ...
    static function load_dictionary()
    {
        $fields = array(
                    ...
                    'load_id' => array('value'=>'',
                                          ...
                                          'date_default'=>'',
                                          'list_type'=>'sql generated',
                                          'list_settings'=>array('query' => "SELECT facultyload.load_id AS `Queried_load_id`, facultyload.emp_id FROM facultyload ORDER BY `emp_id`, `Queried_load_id`",
                                                                     'list_value' => 'Queried_load_id',
                                                                     'list_items' => array('emp_id', 'Queried_load_id'),
                                                                     'list_separators' => array()),
                                          'rpt_in_report'=>TRUE,
                                          'rpt_column_format'=>'normal',
                                          'rpt_column_alignment'=>'center',
    ...
    static function load_relationships()
    {
        $relations = array(array('type'=>'1-M',
                           ...
                           array('type'=>'1-1',
                                 ...
                                 'link_parent'=>'load_id',
                                 'link_child'=>'load_id',
                                 'link_subtext'=>array('emp_id','load_id'),
                                 'where_clause'=>''),
                           array('type'=>'M-1',
                             'table'=>'facultyload',
                             'alias'=>'',
