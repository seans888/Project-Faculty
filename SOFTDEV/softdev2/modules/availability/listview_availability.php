...
//****************************************************************************************
require 'path.php';
init_cobalt('View availability');

$page_title       = 'ListView: %%';
$db_subclass      = 'availability';
$html_subclass    = 'availability_html';
$arr_pkey_name    = array('availability_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add availability';
$edit_link        = 'Edit availability';
$delete_link      = 'Delete availability';
$view_link        = 'View availability';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_availability.php';
$edit_page        = 'edit_availability.php';
$delete_page      = 'delete_availability.php';
$view_page        = 'detailview_availability.php';
$csv_page         = 'csv_availability.php';
$report_page      = 'reporter_availability.php';
