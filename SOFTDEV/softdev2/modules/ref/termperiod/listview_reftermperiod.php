...
$page_title       = 'ListView: %%';
$db_subclass      = 'reftermperiod';
$html_subclass    = 'reftermperiod_html';
$arr_pkey_name    = array('term_id','period');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add reftermperiod';
$edit_link        = 'Edit reftermperiod';
$delete_link      = 'Delete reftermperiod';
$view_link        = 'View reftermperiod';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_reftermperiod.php';
$edit_page        = 'edit_reftermperiod.php';
$delete_page      = 'delete_reftermperiod.php';
$view_page        = 'detailview_reftermperiod.php';
$csv_page         = 'csv_reftermperiod.php';
$report_page      = 'reporter_reftermperiod.php';
