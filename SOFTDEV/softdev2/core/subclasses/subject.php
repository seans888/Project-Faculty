...
class subject extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('subject_id, term_id, subject_code, subject_name, subject_description, unit, pay_unit, compute_GPA, lab_id, group_owner, evaluate_OTE, is_elective, grade_type, accept_substitute, lab_type_id, dept_id, category, assess_note, occupied, specialization_master_id');
            $this->set_values("?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?");

            $bind_params = array('iisssssssssssssiissi',
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("term_id = ?, subject_code = ?, subject_name = ?, subject_description = ?, unit = ?, pay_unit = ?, compute_GPA = ?, lab_id = ?, group_owner = ?, evaluate_OTE = ?, is_elective = ?, grade_type = ?, accept_substitute = ?, lab_type_id = ?, dept_id = ?, category = ?, assess_note = ?, occupied = ?, specialization_master_id = ?");
            $this->set_where("subject_id = ?");

            $bind_params = array('isssssssssssssiissii',
                                 &$this->fields['term_id']['value'],
                                 &$this->fields['subject_code']['value'],
                                 &$this->fields['subject_name']['value'],
                                 &$this->fields['subject_description']['value'],
